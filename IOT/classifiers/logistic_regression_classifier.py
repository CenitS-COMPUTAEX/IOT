...
class LogisticRegressionClassifier(BaseClassifier):
	...
	def __init__(self, logger: Logger, model_dump: object = None):
		...
		model_dump: Trained LR model. If unspecified, this instance must be trained before it can be used for prediction.
		"""
		super().__init__(logger)
		self.trained_model = model_dump

	def get_classifier_type(self) -> ClassifierType:
		return ClassifierType.LOGISTIC_REGRESSION
