...
class TsfClassifier(BaseTimeClassifier):
	"""
	Time Series Forest model, but used to classify multivariate time data.
	...
	def supports_missing_values(self) -> bool:
		return TimeSeriesForestClassifier.get_class_tag("capability:missing_values")

	def get_classifier_type(self) -> TimeClassifierType:
		return TimeClassifierType.TSF
