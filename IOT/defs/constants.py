...
class Constants:
	...
	# Internal name used to refer to the power feature in time datasets
	POWER_TIME_FEATURE_NAME = "Power"
	...
	# Name of the output column that contains an index to identify each row
	NAME_OUT_COLUMN_INDEX = "Index"
	# Name of the output column that contains the timestamp of each instance
	NAME_OUT_COLUMN_TIME = "Time"
	...
	NAME_MODEL_DUMP_FILE = "model.pkl"
	...
	# Name of the folder where the alert files to compress will be stored
	ALERT_FOLDER = "data"
	# Name of the file containing information about the alert sent to an alert server
	ALERT_INFO_FILE = "AlertInfo.txt"
	# Name of the file containing the model prediction sent to an alert server
	ALERT_PREDICTION_FILE = "Prediction.csv"
	# Name of the file containing the X values used to make the prediction sent to an alert server
	ALERT_DATA_FILE = "Data.csv"
	# Name of the file to send to an alert server, without the extension
	ALERT_FILE = "Alert"

	# Name of the folder where GA checkpoints will be stored
	GA_CHECKPOINTS_FOLDER = "Checkpoints"
